...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('sdmbank_core_path', null,
                    $modx->getOption('core_path') . 'components/sdmbank/') . 'model/';
            $modx->addPackage('sdmbank', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/sdmbank/model/schema/sdmbank.mysql.schema.xml';
